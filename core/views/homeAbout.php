            ...
            <div class="about__wrapper">
                ...
                <div class="about__slide">
                    <div class="container">
                        <div class="link" href="">
                            <div class="about__slide-container">
                                <e class="slide-content">
                                    <div class="about__slide-title"><?= $partners_title ?></div>
                                    <div class="about__slide-text"><?= wpautop($partners_content) ?></div>
                        ...
                        <div class="link" href="">
                            <div class="about__slide-container">
                                <div class="slide-content">
                                    <div class="about__slide-title"><?= $clients_title ?></div>
                                    <div class="about__slide-text"> <?= wpautop($clients_content) ?></div>
